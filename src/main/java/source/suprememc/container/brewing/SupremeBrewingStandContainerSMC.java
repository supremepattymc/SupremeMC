package source.suprememc.container.brewing;
...
public class SupremeBrewingStandContainerSMC extends Container {
	private final IInventory brewingStand;
	private final IIntArray brewingStandData;
	private final Slot ingredientSlot;

	public SupremeBrewingStandContainerSMC(int p_i50095_1_, PlayerInventory p_i50095_2_) {
		this(p_i50095_1_, p_i50095_2_, new Inventory(5), new IntArray(2));
	}

	public SupremeBrewingStandContainerSMC(int p_i50096_1_, PlayerInventory p_i50096_2_, IInventory p_i50096_3_, IIntArray p_i50096_4_) {
		super(SMCContainers.SUPREME_BREWING_STAND, p_i50096_1_);
		...
		this.addSlot(new SupremeBrewingStandContainerSMC.PotionSlot(p_i50096_3_, 0, 56, 51));
		this.addSlot(new SupremeBrewingStandContainerSMC.PotionSlot(p_i50096_3_, 1, 79, 58));
		this.addSlot(new SupremeBrewingStandContainerSMC.PotionSlot(p_i50096_3_, 2, 102, 51));
		this.ingredientSlot = this.addSlot(new SupremeBrewingStandContainerSMC.IngredientSlot(p_i50096_3_, 3, 79, 17));
		this.addSlot(new SupremeBrewingStandContainerSMC.FuelSlot(p_i50096_3_, 4, 17, 17));
	...
	public ItemStack quickMoveStack(PlayerEntity p_82846_1_, int p_82846_2_) {
		...
		if (slot != null && slot.hasItem()) {
			...
			if ((p_82846_2_ < 0 || p_82846_2_ > 2) && p_82846_2_ != 3 && p_82846_2_ != 4) {
				if (SupremeBrewingStandContainerSMC.FuelSlot.mayPlaceItem(itemstack)) {
				...
				} else if (SupremeBrewingStandContainerSMC.PotionSlot.mayPlaceItem(itemstack) && itemstack.getCount() == 1) {
	...
	static class FuelSlot extends Slot {
		...
		public static boolean mayPlaceItem(ItemStack p_185004_0_) {
			return p_185004_0_.getItem() == SMCItems.SOUL_BLAZE_POWDER;
		}
	...
	static class IngredientSlot extends Slot {
		...
		public boolean mayPlace(ItemStack p_75214_1_) {
			return BrewingRecipeRegistrySMC.isValidIngredient(p_75214_1_);
		}
	...
	static class PotionSlot extends Slot {
		...
		public static boolean mayPlaceItem(ItemStack p_75243_0_) {
			return BrewingRecipeRegistrySMC.isValidInput(p_75243_0_);
		}
	}
}
