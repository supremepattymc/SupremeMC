package source.suprememc.container.crafting.gui.screen;
...
public class CraftingScreenSMC extends ContainerScreen<WorkbenchContainerSMC> implements IRecipeShownListener {
	private static final ResourceLocation CRAFTING_TABLE_LOCATION = new ResourceLocation("textures/gui/container/crafting_table.png");
	private static final ResourceLocation RECIPE_BUTTON_LOCATION = new ResourceLocation("textures/gui/recipe_button.png");
	private final RecipeBookGui recipeBookComponent = new RecipeBookGui();
	private boolean widthTooNarrow;

	public CraftingScreenSMC(WorkbenchContainerSMC p_i51094_1_, PlayerInventory p_i51094_2_, ITextComponent p_i51094_3_) {
