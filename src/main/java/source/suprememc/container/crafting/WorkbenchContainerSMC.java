package source.suprememc.container.crafting;
...
public class WorkbenchContainerSMC extends RecipeBookContainer<CraftingInventory>
{
	...
	public WorkbenchContainerSMC(int p_i50089_1_, PlayerInventory p_i50089_2_) {
		this(p_i50089_1_, p_i50089_2_, IWorldPosCallable.NULL);
	}

	public WorkbenchContainerSMC(int p_i50090_1_, PlayerInventory p_i50090_2_, IWorldPosCallable p_i50090_3_) {
		super(SMCContainers.CRAFTING, p_i50090_1_);
	...
	public boolean stillValid(PlayerEntity p_75145_1_) {
		return 
		(
			stillValid(this.access, p_75145_1_, SMCBlocks.ACACIA_CRAFTING_TABLE) ||
			stillValid(this.access, p_75145_1_, SMCBlocks.BIRCH_CRAFTING_TABLE) ||
			stillValid(this.access, p_75145_1_, SMCBlocks.DARK_OAK_CRAFTING_TABLE) ||
			stillValid(this.access, p_75145_1_, SMCBlocks.JUNGLE_CRAFTING_TABLE) ||
			stillValid(this.access, p_75145_1_, SMCBlocks.LAVENDER_CRAFTING_TABLE) ||
			stillValid(this.access, p_75145_1_, SMCBlocks.SPRUCE_CRAFTING_TABLE) ||
			stillValid(this.access, p_75145_1_, SMCBlocks.CRIMSON_CRAFTING_TABLE) ||
			stillValid(this.access, p_75145_1_, SMCBlocks.WARPED_CRAFTING_TABLE) ||
			stillValid(this.access, p_75145_1_, SMCBlocks.PALM_CRAFTING_TABLE) ||
			stillValid(this.access, p_75145_1_, SMCBlocks.MUSTARD_CRAFTING_TABLE)
		);
	}
