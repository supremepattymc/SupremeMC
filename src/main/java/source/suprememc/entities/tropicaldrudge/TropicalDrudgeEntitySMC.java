...
public class TropicalDrudgeEntitySMC extends ZombieEntity {
	public TropicalDrudgeEntitySMC(EntityType<? extends TropicalDrudgeEntitySMC> p_i50204_1_, World p_i50204_2_) {
		super(p_i50204_1_, p_i50204_2_);
	}

	public static boolean checkTropicalDrudgeSpawnRules(EntityType<TropicalDrudgeEntitySMC> p_223334_0_, IServerWorld p_223334_1_, SpawnReason p_223334_2_, BlockPos p_223334_3_, Random p_223334_4_) {
	...
	public boolean doHurtTarget(Entity p_70652_1_) {
		...
		if (flag && this.getMainHandItem().isEmpty() && p_70652_1_ instanceof LivingEntity) {
			...
			((LivingEntity)p_70652_1_).addEffect(new EffectInstance(Effects.CONFUSION, 140 * (int)f));
		}
