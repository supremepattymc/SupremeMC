...
public class CavedEntitySMC extends ZombieEntity {
	public CavedEntitySMC(EntityType<? extends CavedEntitySMC> p_i50204_1_, World p_i50204_2_) {
		super(p_i50204_1_, p_i50204_2_);
	}

	public static boolean checkHuskSpawnRules(EntityType<CavedEntitySMC> p_223334_0_, IServerWorld p_223334_1_, SpawnReason p_223334_2_, BlockPos p_223334_3_, Random p_223334_4_) {
	...
	public boolean doHurtTarget(Entity p_70652_1_) {
		...
		if (flag && this.getMainHandItem().isEmpty() && p_70652_1_ instanceof LivingEntity) {
			...
			((LivingEntity)p_70652_1_).addEffect(new EffectInstance(Effects.BLINDNESS, 140 * (int)f));
		}
