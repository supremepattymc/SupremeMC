...
@OnlyIn(Dist.CLIENT)
public class CavedModelSMC<T extends ZombieEntity> extends ZombieModel<T> {
	public CavedModelSMC(float p_i48915_1_, float p_i48915_2_, int p_i48915_3_, int p_i48915_4_) {
	...
	public CavedModelSMC(float p_i49398_1_, boolean p_i49398_2_) {
