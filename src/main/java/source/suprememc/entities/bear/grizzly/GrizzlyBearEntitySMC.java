...
public class GrizzlyBearEntitySMC extends AnimalEntity implements IAngerable {
	private static final DataParameter<Boolean> DATA_STANDING_ID = EntityDataManager.defineId(GrizzlyBearEntitySMC.class, DataSerializers.BOOLEAN);
	...
	public GrizzlyBearEntitySMC(EntityType<? extends GrizzlyBearEntitySMC> p_i50249_1_, World p_i50249_2_) {
		super(p_i50249_1_, p_i50249_2_);
	}

	public AgeableEntity getBreedOffspring(ServerWorld p_241840_1_, AgeableEntity p_241840_2_) {
		return SMCEntities.GRIZZLY_BEAR.create(p_241840_1_);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new GrizzlyBearEntitySMC.MeleeAttackGoal());
		this.goalSelector.addGoal(1, new GrizzlyBearEntitySMC.PanicGoal());
		this.goalSelector.addGoal(4, new FollowParentGoal(this, 1.25D));
		this.goalSelector.addGoal(5, new RandomWalkingGoal(this, 1.0D));
		this.goalSelector.addGoal(6, new LookAtGoal(this, PlayerEntity.class, 6.0F));
		this.goalSelector.addGoal(7, new LookRandomlyGoal(this));
		this.targetSelector.addGoal(1, new GrizzlyBearEntitySMC.HurtByTargetGoal());
		this.targetSelector.addGoal(2, new GrizzlyBearEntitySMC.AttackPlayerGoal());
	...
	public static boolean checkPolarBearSpawnRules(EntityType<GrizzlyBearEntitySMC> p_223320_0_, IWorld p_223320_1_, SpawnReason p_223320_2_, BlockPos p_223320_3_, Random p_223320_4_) {
	...
	class AttackPlayerGoal extends NearestAttackableTargetGoal<PlayerEntity> {
		public AttackPlayerGoal() {
			super(GrizzlyBearEntitySMC.this, PlayerEntity.class, 20, true, true, (Predicate<LivingEntity>)null);
		}

		public boolean canUse() {
			if (GrizzlyBearEntitySMC.this.isBaby()) {
				return false;
			} else {
				if (super.canUse()) {
					for(GrizzlyBearEntitySMC BearEntitySMC : GrizzlyBearEntitySMC.this.level.getEntitiesOfClass(GrizzlyBearEntitySMC.class, GrizzlyBearEntitySMC.this.getBoundingBox().inflate(8.0D, 4.0D, 8.0D))) {
						if (BearEntitySMC.isBaby()) {
							return true;
						}
					}
				}
	...
	class HurtByTargetGoal extends net.minecraft.entity.ai.goal.HurtByTargetGoal {
		public HurtByTargetGoal() {
			super(GrizzlyBearEntitySMC.this);
		}
		...
		protected void alertOther(MobEntity p_220793_1_, LivingEntity p_220793_2_) {
			if (p_220793_1_ instanceof GrizzlyBearEntitySMC && !p_220793_1_.isBaby()) {
	...
	class MeleeAttackGoal extends net.minecraft.entity.ai.goal.MeleeAttackGoal {
		public MeleeAttackGoal() {
			super(GrizzlyBearEntitySMC.this, 1.25D, true);
		}
		...
		protected void checkAndPerformAttack(LivingEntity p_190102_1_, double p_190102_2_) {
			...
			if (p_190102_2_ <= d0 && this.isTimeToAttack()) {
				...
				GrizzlyBearEntitySMC.this.setStanding(false);
				...
				if (this.getTicksUntilNextAttack() <= 10) {
					GrizzlyBearEntitySMC.this.setStanding(true);
					GrizzlyBearEntitySMC.this.playWarningSound();
				}
			} else {
				this.resetAttackCooldown();
				GrizzlyBearEntitySMC.this.setStanding(false);
	...
	class PanicGoal extends net.minecraft.entity.ai.goal.PanicGoal {
		public PanicGoal() {
			super(GrizzlyBearEntitySMC.this, 2.0D);
		}

		public boolean canUse() {
			return !GrizzlyBearEntitySMC.this.isBaby() && !GrizzlyBearEntitySMC.this.isOnFire() ? false : super.canUse();
		}
	}
}
