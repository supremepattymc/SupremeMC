...
public class FireCreeperEntitySMC extends MonsterEntity implements IChargeableMob 
{
	private static final DataParameter<Integer> DATA_SWELL_DIR = EntityDataManager.defineId(FireCreeperEntitySMC.class, DataSerializers.INT);
	private static final DataParameter<Boolean> DATA_IS_POWERED = EntityDataManager.defineId(FireCreeperEntitySMC.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> DATA_IS_IGNITED = EntityDataManager.defineId(FireCreeperEntitySMC.class, DataSerializers.BOOLEAN);
	...
	public FireCreeperEntitySMC(EntityType<? extends FireCreeperEntitySMC> p_i50213_1_, World p_i50213_2_) 
	{
		super(p_i50213_1_, p_i50213_2_);
	}

	public static boolean checkFireCreeperSpawnRules(EntityType<FireCreeperEntitySMC> entityType, IWorld iWorld, SpawnReason spawnReason, BlockPos blockPos, Random random) 
	{
		return !iWorld.getBlockState(blockPos.below()).is(SMCBlocks.MUSTARD_WART_BLOCK);
	}
	...
	protected void dropCustomDeathLoot(DamageSource p_213333_1_, int p_213333_2_, boolean p_213333_3_) {
		...
		if (entity != this && entity instanceof FireCreeperEntitySMC) {
			FireCreeperEntitySMC creeperentity = (FireCreeperEntitySMC)entity;
	...
	private void explodeCreeper() {
		if (!this.level.isClientSide) {
			...
			this.dead = true;
			this.level.explode(this, this.getX(), this.getY(), this.getZ(), (float)this.explosionRadius * f, true, explosion$mode);
			this.remove();
