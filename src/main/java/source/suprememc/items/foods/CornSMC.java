...
public class CornSMC extends Item
{
	public CornSMC(String name) 
	{
		super(new Properties().tab(SMCTabs.FOODS).food(SMCFoods.CORN));
	...
	{
		BlockState blockstate = SMCBlocks.CORN_STALK.getStateForPlacement(context);
