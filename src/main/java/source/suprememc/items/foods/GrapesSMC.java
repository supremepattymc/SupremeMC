...
public class GrapesSMC extends Item
{
	public GrapesSMC(String name) 
	{
		super(new Properties().tab(SMCTabs.FOODS).food(SMCFoods.GRAPES));
	...
	{
		BlockState blockstate = SMCBlocks.GRAPE_VINE.getStateForPlacement(context);
