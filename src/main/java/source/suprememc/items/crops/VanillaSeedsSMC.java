package source.suprememc.items.crops;
...
public class VanillaSeedsSMC extends Item
{
	public VanillaSeedsSMC(String name) 
	{
	...
	{
		BlockState blockstate = SMCBlocks.VANILLA_CROPS.getStateForPlacement(context);
