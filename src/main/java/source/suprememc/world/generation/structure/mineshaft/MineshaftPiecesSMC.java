...
public class MineshaftPiecesSMC {
   private static MineshaftPiecesSMC.Piece createRandomShaftPiece(List<StructurePiece> p_189940_0_, Random p_189940_1_, int p_189940_2_, int p_189940_3_, int p_189940_4_, @Nullable Direction p_189940_5_, int p_189940_6_, MineshaftStructureSMC.Type p_189940_7_) {
      int i = p_189940_1_.nextInt(100);
      if (i >= 80) {
         MutableBoundingBox mutableboundingbox = MineshaftPiecesSMC.Cross.findCrossing(p_189940_0_, p_189940_1_, p_189940_2_, p_189940_3_, p_189940_4_, p_189940_5_);
         if (mutableboundingbox != null) {
            return new MineshaftPiecesSMC.Cross(p_189940_6_, mutableboundingbox, p_189940_5_, p_189940_7_);
         }
      } else if (i >= 70) {
         MutableBoundingBox mutableboundingbox1 = MineshaftPiecesSMC.Stairs.findStairs(p_189940_0_, p_189940_1_, p_189940_2_, p_189940_3_, p_189940_4_, p_189940_5_);
         if (mutableboundingbox1 != null) {
            return new MineshaftPiecesSMC.Stairs(p_189940_6_, mutableboundingbox1, p_189940_5_, p_189940_7_);
         }
      } else {
         MutableBoundingBox mutableboundingbox2 = MineshaftPiecesSMC.Corridor.findCorridorSize(p_189940_0_, p_189940_1_, p_189940_2_, p_189940_3_, p_189940_4_, p_189940_5_);
         if (mutableboundingbox2 != null) {
            return new MineshaftPiecesSMC.Corridor(p_189940_6_, p_189940_1_, mutableboundingbox2, p_189940_5_, p_189940_7_);
         }
      }
   ...
   private static MineshaftPiecesSMC.Piece generateAndAddPiece(StructurePiece p_189938_0_, List<StructurePiece> p_189938_1_, Random p_189938_2_, int p_189938_3_, int p_189938_4_, int p_189938_5_, Direction p_189938_6_, int p_189938_7_) {
      if (p_189938_7_ > 8) {
         return null;
      } else if (Math.abs(p_189938_3_ - p_189938_0_.getBoundingBox().x0) <= 80 && Math.abs(p_189938_5_ - p_189938_0_.getBoundingBox().z0) <= 80) {
         MineshaftStructureSMC.Type mineshaftstructure$type = ((MineshaftPiecesSMC.Piece)p_189938_0_).type;
         MineshaftPiecesSMC.Piece mineshaftpieces$piece = createRandomShaftPiece(p_189938_1_, p_189938_2_, p_189938_3_, p_189938_4_, p_189938_5_, p_189938_6_, p_189938_7_ + 1, mineshaftstructure$type);
   ...
   public static class Corridor extends MineshaftPiecesSMC.Piece {
      ...
      public Corridor(int p_i47140_1_, Random p_i47140_2_, MutableBoundingBox p_i47140_3_, Direction p_i47140_4_, MineshaftStructureSMC.Type p_i47140_5_) {
      ...
      public void addChildren(StructurePiece p_74861_1_, List<StructurePiece> p_74861_2_, Random p_74861_3_) {
         ...
         if (direction != null) {
            ...
            default:
               if (j <= 1) {
                  MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x0, this.boundingBox.y0 - 1 + p_74861_3_.nextInt(3), this.boundingBox.z0 - 1, direction, i);
               } else if (j == 2) {
                  MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x0 - 1, this.boundingBox.y0 - 1 + p_74861_3_.nextInt(3), this.boundingBox.z0, Direction.WEST, i);
               } else {
                  MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x1 + 1, this.boundingBox.y0 - 1 + p_74861_3_.nextInt(3), this.boundingBox.z0, Direction.EAST, i);
               }
               break;
            case SOUTH:
               if (j <= 1) {
                  MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x0, this.boundingBox.y0 - 1 + p_74861_3_.nextInt(3), this.boundingBox.z1 + 1, direction, i);
               } else if (j == 2) {
                  MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x0 - 1, this.boundingBox.y0 - 1 + p_74861_3_.nextInt(3), this.boundingBox.z1 - 3, Direction.WEST, i);
               } else {
                  MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x1 + 1, this.boundingBox.y0 - 1 + p_74861_3_.nextInt(3), this.boundingBox.z1 - 3, Direction.EAST, i);
               }
               break;
            case WEST:
               if (j <= 1) {
                  MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x0 - 1, this.boundingBox.y0 - 1 + p_74861_3_.nextInt(3), this.boundingBox.z0, direction, i);
               } else if (j == 2) {
                  MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x0, this.boundingBox.y0 - 1 + p_74861_3_.nextInt(3), this.boundingBox.z0 - 1, Direction.NORTH, i);
               } else {
                  MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x0, this.boundingBox.y0 - 1 + p_74861_3_.nextInt(3), this.boundingBox.z1 + 1, Direction.SOUTH, i);
               }
               break;
            case EAST:
               if (j <= 1) {
                  MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x1 + 1, this.boundingBox.y0 - 1 + p_74861_3_.nextInt(3), this.boundingBox.z0, direction, i);
               } else if (j == 2) {
                  MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x1 - 3, this.boundingBox.y0 - 1 + p_74861_3_.nextInt(3), this.boundingBox.z0 - 1, Direction.NORTH, i);
               } else {
                  MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x1 - 3, this.boundingBox.y0 - 1 + p_74861_3_.nextInt(3), this.boundingBox.z1 + 1, Direction.SOUTH, i);
               }
            }
         }
         ...
         if (i < 8) {
            if (direction != Direction.NORTH && direction != Direction.SOUTH) {
               for(int i1 = this.boundingBox.x0 + 3; i1 + 3 <= this.boundingBox.x1; i1 += 5) {
                  ...
                  if (j1 == 0) {
                     MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, i1, this.boundingBox.y0, this.boundingBox.z0 - 1, Direction.NORTH, i + 1);
                  } else if (j1 == 1) {
                     MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, i1, this.boundingBox.y0, this.boundingBox.z1 + 1, Direction.SOUTH, i + 1);
                  }
               }
            } else {
               for(int k = this.boundingBox.z0 + 3; k + 3 <= this.boundingBox.z1; k += 5) {
                  ...
                  if (l == 0) {
                     MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x0 - 1, this.boundingBox.y0, k, Direction.WEST, i + 1);
                  } else if (l == 1) {
                     MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x1 + 1, this.boundingBox.y0, k, Direction.EAST, i + 1);
                  }
               }
            }
         }
   ...
   public static class Cross extends MineshaftPiecesSMC.Piece {
      ...
      public Cross(int p_i50455_1_, MutableBoundingBox p_i50455_2_, @Nullable Direction p_i50455_3_, MineshaftStructureSMC.Type p_i50455_4_) {
      ...
      public void addChildren(StructurePiece p_74861_1_, List<StructurePiece> p_74861_2_, Random p_74861_3_) {
         ...
         case NORTH:
         default:
            MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x0 + 1, this.boundingBox.y0, this.boundingBox.z0 - 1, Direction.NORTH, i);
            MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x0 - 1, this.boundingBox.y0, this.boundingBox.z0 + 1, Direction.WEST, i);
            MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x1 + 1, this.boundingBox.y0, this.boundingBox.z0 + 1, Direction.EAST, i);
            break;
         case SOUTH:
            MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x0 + 1, this.boundingBox.y0, this.boundingBox.z1 + 1, Direction.SOUTH, i);
            MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x0 - 1, this.boundingBox.y0, this.boundingBox.z0 + 1, Direction.WEST, i);
            MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x1 + 1, this.boundingBox.y0, this.boundingBox.z0 + 1, Direction.EAST, i);
            break;
         case WEST:
         ...
         if (this.isTwoFloored) {
            if (p_74861_3_.nextBoolean()) {
               MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x0 + 1, this.boundingBox.y0 + 3 + 1, this.boundingBox.z0 - 1, Direction.NORTH, i);
            }

            if (p_74861_3_.nextBoolean()) {
               MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x0 - 1, this.boundingBox.y0 + 3 + 1, this.boundingBox.z0 + 1, Direction.WEST, i);
            }

            if (p_74861_3_.nextBoolean()) {
               MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x1 + 1, this.boundingBox.y0 + 3 + 1, this.boundingBox.z0 + 1, Direction.EAST, i);
            }

            if (p_74861_3_.nextBoolean()) {
               MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x0 + 1, this.boundingBox.y0 + 3 + 1, this.boundingBox.z1 + 1, Direction.SOUTH, i);
            }
         }
   ...
   abstract static class Piece extends StructurePiece {
      protected MineshaftStructureSMC.Type type;

      public Piece(IStructurePieceType p_i50452_1_, int p_i50452_2_, MineshaftStructureSMC.Type p_i50452_3_) {
      ...
      public Piece(IStructurePieceType p_i50453_1_, CompoundNBT p_i50453_2_) {
         ...
         this.type = MineshaftStructureSMC.Type.byId(p_i50453_2_.getInt("MST"));
      }
      ...
      protected BlockState getPlanksBlock() {
         ...
         case MUSTARD:
             return SMCBlocks.MUSTARD_PLANKS.defaultBlockState();
         case NETHER:
      ...
      protected BlockState getFenceBlock() {
         ...
         case MUSTARD:
             return SMCBlocks.MUSTARD_FENCE.defaultBlockState();
         case NETHER:
   ...
   public static class Room extends MineshaftPiecesSMC.Piece {
      private final List<MutableBoundingBox> childEntranceBoxes = Lists.newLinkedList();

      public Room(int p_i47137_1_, Random p_i47137_2_, int p_i47137_3_, int p_i47137_4_, MineshaftStructureSMC.Type p_i47137_5_) {
      ...
      public void addChildren(StructurePiece p_74861_1_, List<StructurePiece> p_74861_2_, Random p_74861_3_) {
         ...
         for(k = 0; k < this.boundingBox.getXSpan(); k = k + 4) {
            ...
            MineshaftPiecesSMC.Piece mineshaftpieces$piece = MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x0 + k, this.boundingBox.y0 + p_74861_3_.nextInt(j) + 1, this.boundingBox.z0 - 1, Direction.NORTH, i);
            if (mineshaftpieces$piece != null) {
         ...
         for(k = 0; k < this.boundingBox.getXSpan(); k = k + 4) {
            ...
            MineshaftPiecesSMC.Piece mineshaftpieces$piece1 = MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x0 + k, this.boundingBox.y0 + p_74861_3_.nextInt(j) + 1, this.boundingBox.z1 + 1, Direction.SOUTH, i);
         ...
         for(k = 0; k < this.boundingBox.getZSpan(); k = k + 4) {
            ...
            MineshaftPiecesSMC.Piece mineshaftpieces$piece2 = MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x0 - 1, this.boundingBox.y0 + p_74861_3_.nextInt(j) + 1, this.boundingBox.z0 + k, Direction.WEST, i);
         ...
         for(k = 0; k < this.boundingBox.getZSpan(); k = k + 4) {
            ...
            StructurePiece structurepiece = MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x1 + 1, this.boundingBox.y0 + p_74861_3_.nextInt(j) + 1, this.boundingBox.z0 + k, Direction.EAST, i);
   ...
   public static class Stairs extends MineshaftPiecesSMC.Piece {
      public Stairs(int p_i50449_1_, MutableBoundingBox p_i50449_2_, Direction p_i50449_3_, MineshaftStructureSMC.Type p_i50449_4_) {
      ...
      public void addChildren(StructurePiece p_74861_1_, List<StructurePiece> p_74861_2_, Random p_74861_3_) {
         ...
         if (direction != null) {
            ...
            case NORTH:
            default:
               MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x0, this.boundingBox.y0, this.boundingBox.z0 - 1, Direction.NORTH, i);
               break;
            case SOUTH:
               MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x0, this.boundingBox.y0, this.boundingBox.z1 + 1, Direction.SOUTH, i);
               break;
            case WEST:
               MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x0 - 1, this.boundingBox.y0, this.boundingBox.z0, Direction.WEST, i);
               break;
            case EAST:
               MineshaftPiecesSMC.generateAndAddPiece(p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.x1 + 1, this.boundingBox.y0, this.boundingBox.z0, Direction.EAST, i);
            }
         }
