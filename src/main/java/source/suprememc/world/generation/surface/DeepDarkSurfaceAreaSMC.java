...
public class DeepDarkSurfaceAreaSMC extends SurfaceBuilder<SurfaceBuilderConfig> {
	   private static final BlockState GRAVEL = Blocks.GRAVEL.defaultBlockState();
	   private static final BlockState TUFF = SMCBlocks.TUFF.defaultBlockState();
	   protected long seed;
	   protected OctavesNoiseGenerator decorationNoise;

	   public DeepDarkSurfaceAreaSMC(Codec<SurfaceBuilderConfig> p_i232132_1_) {
	      super(p_i232132_1_);
	   }
