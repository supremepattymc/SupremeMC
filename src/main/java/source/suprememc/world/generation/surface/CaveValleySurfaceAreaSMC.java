...
public class CaveValleySurfaceAreaSMC extends ValleySurfaceBuilder 
{
	private long seed;
	...
	public CaveValleySurfaceAreaSMC(Block block, Codec<SurfaceBuilderConfig> codec) 
	{
		super(codec);
	...
	{
		return ImmutableList.of(this.blockState);
	}
	...
	public void apply(Random p_205610_1_, IChunk p_205610_2_, Biome p_205610_3_, int p_205610_4_, int p_205610_5_, int p_205610_6_, double p_205610_7_, BlockState p_205610_9_, BlockState p_205610_10_, int p_205610_11_, long p_205610_12_, SurfaceBuilderConfig p_205610_14_) {
		...
		double d0 = 0.03125D;
		boolean flag = this.patchNoise.getValue((double)p_205610_4_ * d0, 237.0D, (double)p_205610_5_ * d0) * 75.0D + p_205610_1_.nextDouble() > 0.0D;
