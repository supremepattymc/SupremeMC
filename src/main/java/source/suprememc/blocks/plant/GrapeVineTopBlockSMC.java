...
public class GrapeVineTopBlockSMC extends AbstractTopPlantBlock 
{
	protected static final VoxelShape SHAPE = Block.box(4.0D, 9.0D, 4.0D, 12.0D, 16.0D, 12.0D);
	public GrapeVineTopBlockSMC(String name) 
	{
		super(Properties.of(Material.PLANT, MaterialColor.GRASS).noCollission().instabreak().sound(SoundType.WEEPING_VINES), Direction.DOWN, SHAPE, false, 0.1D);
	...
	{
		return SMCBlocks.GRAPE_VINE_PLANT;
	}
