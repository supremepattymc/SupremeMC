...
public class CookingRecipeSerializerSMC <T extends AbstractCookingRecipe> extends net.minecraftforge.registries.ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<T>
{
	private final int defaultCookingTime;
	private final CookingRecipeSerializerSMC.IFactory<T> factory;

	public CookingRecipeSerializerSMC(CookingRecipeSerializerSMC.IFactory<T> p_i50025_1_, int p_i50025_2_) {
