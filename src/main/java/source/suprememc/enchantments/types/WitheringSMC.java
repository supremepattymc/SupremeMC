...
public class WitheringSMC extends EnchantmentSMC
{
	public WitheringSMC(Rarity rarityIn, EnchantmentType typeIn, EquipmentSlotType[] slots, String name) {super(rarityIn, typeIn, slots, name);}
	...
	{
		EffectHandlerSMC.entityHitByEnchantment(user, target, EffectSMC.WITHER, 10, 2, level, true);
