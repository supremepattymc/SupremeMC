...
public class DioriteCaveBiomeSMC extends BiomeSMC
{
	/**
	 * @link net.minecraft.world.biome.BiomeMaker;
	 */
	public DioriteCaveBiomeSMC(String name) 
	{
		super(name);
	}
	...
	{
		builder.surfaceBuilder(SMCSurfaceBuilders.DIORITE_CAVE_SURFACE);
		...
		builder.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, SMCFeatures.DIORITE_PILLAR);
