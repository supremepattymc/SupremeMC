...
public class BlackstoneCaveBiomeSMC extends BiomeSMC
{
	/**
	 * @link net.minecraft.world.biome.BiomeMaker;
	 */
	public BlackstoneCaveBiomeSMC(String name) 
	{
		super(name);
	}
	...
	{
		builder.surfaceBuilder(SMCSurfaceBuilders.BLACKSTONE_CAVE_SURFACE);
		...
		builder.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, SMCFeatures.BLACKSTONE_PILLAR);
		builder.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, SMCOreFeatures.GILDED_ORE);
