...
public class GraniteCaveBiomeSMC extends BiomeSMC
{
	/**
	 * @link net.minecraft.world.biome.BiomeMaker;
	 */
	public GraniteCaveBiomeSMC(String name) 
	{
		super(name);
	}
	...
	{
		builder.surfaceBuilder(SMCSurfaceBuilders.GRANITE_CAVE_SURFACE);
		...
		builder.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, SMCFeatures.GRANITE_PILLAR);
