...
public class DeepDarkBiomeSMC extends BiomeSMC
{

	public DeepDarkBiomeSMC(String name) 
	{
		super(name);
	}
	...
	{
		builder.surfaceBuilder(SMCSurfaceBuilders.DEEP_DARK_SURFACE);
		...
		builder.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, SMCFeatures.DEEPSLATE_PILLAR);
