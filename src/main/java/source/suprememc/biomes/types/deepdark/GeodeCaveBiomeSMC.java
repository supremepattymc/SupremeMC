...
public class GeodeCaveBiomeSMC extends BiomeSMC
{
	/**
	 * @link net.minecraft.world.biome.BiomeMaker;
	 */
	public GeodeCaveBiomeSMC(String name) 
	{
		super(name);
	}
	...
	{
		builder.surfaceBuilder(SMCSurfaceBuilders.GEODE_CAVE_SURFACE);
		...
		builder.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, SMCOreFeatures.AMETHYST);
		builder.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, SMCFeatures.CALCITE_PILLAR);
